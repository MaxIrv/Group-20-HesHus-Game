 ...
 * from a tile map. Player can interact and trigger events with these objects.
 */
public class GameObject extends Rectangle {
  ...
  /**
   * Creates an instance of a GameObject without MapProperties, functions similarly to just a
   * normal rectangle.
   *
  ...
  /**
   * Gets a property from a key and casts it to a float.
   *
   ...
   *
   * @param y The new Y coordinate of the centre of the object
   */
   ...
   *
   * @param x The new X coordinate of the centre of the object
   */
