...
/**
 * The TimeUpdatedEvent class represents an event that is triggered when the time is updated in the
 * game. This event carries the updated time in seconds of the day.
 */
