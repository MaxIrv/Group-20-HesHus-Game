...
/**
 * The CameraPositionEvent class represents an event that is triggered when the camera position is
 * updated in the game. This event carries the updated camera position.
 */
