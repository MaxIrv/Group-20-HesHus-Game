...
/**
 * The FadeBlackScreenEvent class represents an event that is triggered when the screen needs to fade to black.
 * This event carries an Action that defines the fade animation and an optional RunnableAction that can be executed after the fade.
 */
