...
/**
 * The DialogueSetText class represents an event that is triggered when the text of a dialogue box
 * is set in the game. This event carries the new text and an optional event key associated with the
 * text.
 */
