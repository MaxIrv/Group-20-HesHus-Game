...
/**
 * The DialogueUpdateState class represents an event that is triggered when the state of a dialogue box is updated in the game.
 * This event carries the updated state of the dialogue box.
 */
